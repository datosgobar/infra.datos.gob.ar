...
if [ "$ENVIRONMENT" == "testing" ]; then
    ...
    export DEPLOY_TARGET_SUDO_PASS="$TESTING_DEPLOY_TARGET_SUDO_PASS"
    export DEPLOY_ENVIRONMENT="$ENVIRONMENT"
    export MTU_VALUE="${INFRA_MTU_VALUE:-$DEFAULT_MTU_VALUE}"
    ...
    export DEPLOY_TARGET_SUDO_PASS="$STAGING_DEPLOY_TARGET_SUDO_PASS"
    export DEPLOY_ENVIRONMENT="$ENVIRONMENT"
