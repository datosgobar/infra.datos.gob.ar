...
urlpatterns = [
    ...
    path('<int:node_id>/distribution-identifier-autocomplete/',
         catalog_views.DistributionIdentifierAutocomplete.as_view(),
         name='distribution-identifier-autocomplete')
]
