...
export files_key_var_name="encrypted_18a955bdc681_key"
export files_iv_var_name="encrypted_18a955bdc681_iv"
...
cp "$environment_files/build+infra@travis-ci.org" /tmp/build\+infra@travis-ci.org
chmod 600 /tmp/build\+infra@travis-ci.org
